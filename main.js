...
function OnBtnClick(e)
{
	...
	gAll.uiCanvas.style.display = "block"
	gAll.glCanvas.style.display = "block"
	editBox.style.display = "block";
	editBox1.style.display = "block";
	editBox.visible = true;
	editBox1.visible = true;
	uiButtons[0].visible = true;
	...
	if(bDemoVideo)
	{
		...
		gAll.uiCanvas.style.display = "none"
		gAll.glCanvas.style.display = "none"
		editBox.style.display = "none";
		editBox1.style.display = "none";

		uiButtons[0].visible = false;
		uiButtons[1].visible = false;
		uiButtons[2].visible = false;
		uiButtons[3].visible = false;
		uiButtons[4].visible = false;
		return;
